...
6. §5 가드레일 R-1~R-19 인지 (R-9 일반화 한계 + R-10 양식 일관 + R-11 team_size·members 정합 + R-12 dimension preset 컨텍스트 + R-13 §변경 이력 다중 entry + R-14 orphan 정리 + R-15 ps1 BOM 의무 + R-16 간소 모드 + R-17 frontmatter ↔ §변경 이력 정합 grep 의무 + R-18 agent 양식 공통 결함 = 全 agent 적용 의무 + **R-19 PM 외부 리서치 = 외부 사실 인용 시만, 내부 메타 작업 면제 예외**)
...
마스터플랜 §6 R-1~R-5 + 본 비전 누적 R-6~R-19 가드 운영:
