...
- Run a writing-refinement skill only when the user explicitly asks for it.
...
- Common rules and skills are edited in the source repo, copied to the active Codex directories, and verified by hash.
- User-specific Codex configuration is never overwritten automatically.
