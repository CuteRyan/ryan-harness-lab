...
- issue#32732로 PM이 Sonnet으로 spawn 되는 경우 → `CLAUDE_CODE_SUBAGENT_MODEL` env 설정 재확인
...
| PM이 Sonnet으로 spawn 됨 | issue#32732 | CLAUDE_CODE_SUBAGENT_MODEL + pm.yaml model 재확인 |
...
| 1 | issue#32732 PM Sonnet으로 spawn | 중간 | 이중 보장 설정 + 실험 확인 |
